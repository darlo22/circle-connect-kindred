    ...
    <footer className="bg-navy text-white pt-16 pb-8">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-teal">Quick Links</h3>
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-teal">Resources</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-teal">Contact Us</h3>
            <ul className="space-y-2">
              <li className="text-gray-300">
                <span className="block">Email:</span>
                <a href="mailto:hello@circlemate.com" className="text-teal hover:underline">hello@circlemate.com</a>
              </li>
              <li className="text-gray-300">
                <span className="block">Follow Us:</span>
                <span className="text-teal">@circlemate</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="border-t border-gray-700 mt-10 pt-6">
          <p className="text-center text-gray-400 text-sm">
            © {new Date().getFullYear()} CircleMate. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
